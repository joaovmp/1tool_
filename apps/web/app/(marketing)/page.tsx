  ...
  return (
    <div className={' flex flex-col space-y-24 pt-2 md:pt-14 lg:pt-14 justify-center items-center text-[#1B2151] bg-[#F4F4F4]'}>
      <section className="py-12 px-4 max-w-[100vw]">
        <h1 className="animation-element appear text-[30px] md:text-[60px] lg:text-[60px] md:text-4xl font-bold px-4 md:px-60 lg:px-60 leading-[30px] md:leading-[65px] lg:leading-[65px] text-center mb-4 text-[#1B2151]">
        ...
        <p className="animation-element appear text-xl md:text-3xl mb-8 text-center px-4  md:px-80 lg:px-80  text-[#1B2151]">
        ...
        <p className='animation-element appear text-2xl md:text-4xl lg:text-4xl text-center font-bold'>
          CLIQUE E ASSISTA O VÍDEO
        </p>
      </section >
      <section className='animation-element appear relative w-full px-4 md:px-8 lg:px-8 flex items-center justify-center'>
        <div className='animation-element appear absolute w-[30vw] top-[-28vw] right-0'>
      ...
      <div className='w-full'>
        <div className='animation-element appear flex w-full px-2 md:px-4 lg:px-4 justify-center'>
        ...
        <p className='animation-element appear flex justify-center text-xl lg:text-2xl font-bold text-[#1B2151] py-5'>
          A Revolução Digital
        </p>
        <div className='animation-element appear w-full'>
        ...
        <div className='animation-element appear z-20 relative w-full'>
          <div className='hidden md:block lg:block absolute right-[50px] bottom-[-220px]'>
            <Image src={'/images/pastaEmigre.svg'} alt='flag' width={534} height={355} layout='responsive' />
          </div>
        </div>
        <div className='animation-element appear flex justify-center w-full my-8 px-4 md:px-10 lg:px-10'>
          <div className='animation-element appear my-4 border-2 border-[#00B6FF] rounded-md w-full md:w-[60vw] lg:w-[60vw] p-4 md:p-14 lg:p-14 flex flex-col gap-4 bg-white'>
            <div className='animation-element appear text-2xl md:text-4xl lg:text-4xl font-bold border-b-2 p-4 border-[#00B6FF]'>

              Transformando o Processo Consular
            </div>
            <div className='animation-element appear flex flex-col gap-4 px-4'>
              <p>
            ...
            <div className='animation-element appear flex gap-4 items-start'>
      ...
      <div className='relative w-full bg-[#1B2151] py-10 text-white flex flex-col gap-20'>
        <div className='animation-element appear  rotate-45 absolute top-[-19vw] left-[-3vw] w-[20vw]'>
          <Image src={'/images/flag-usa.svg'} alt='flag' width={357} height={398} layout='responsive' />
        </div>
        <div className='animation-element appear  w-full flex items-center'>
        ...
        <p className='animation-element appear  font-bold text-4xl px-4 text-center'>
          Se você deseja aumentar sua eficiência, reduzir custos e expandir seus serviços.
        </p>
        <p className='animation-element appear text-center px-4'>
      ...
      <div className='animation-element appear relative w-full  text-white '>
        <Feedbacks />
      </div>
      <div className='bg-[#1B2151] py-16 w-full text-white'>
        <div className='text-center'>
          <p className='animation-element appear text-2xl py-16  md:text-4xl lg:text-4xl  sm:px-4 md:px-0 lg:px-0 text-center font-bold'>
          ...
          <div className='animation-element appear text-center pt-60 pb-32 font-medium'>
            BLOCO PLACEHOLDER - O QUE VAMOS ENTREGAR NO MVP
          </div>
          <div className='animation-element appear text-center py-20 sm:w-full md:w-[50%] lg:w-[50%]  px-4  m-auto'>
