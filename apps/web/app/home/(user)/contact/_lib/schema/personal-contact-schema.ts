...
export const PersonalContactFamily_SpouseSchema = z.object({
  ...
  cityOfMarriage: z.string().nullable(),
  stateOfMarriage: z.string().nullable(),
  provinceOfMarriage: z.string().nullable(),
  countryOfMarriage: z.string().nullable(),
  liveTogetherSince: z.string().nullable(),
  liveTogetherUntil: z.string().nullable(),
  reasonMarriageEnded: z.string().nullable(),
  dateMarriageEnded: z.string().nullable(),
  citymarriageEnded: z.string().nullable(),
  stateMarriageEnded: z.string().nullable(),
  provinceMarriageEnded: z.string().nullable(),
