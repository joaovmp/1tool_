...
export const PersonalContactFamily_SpouseSchema = z.object({
  ...
  cityOfMarriage: z.string(),
  stateOfMarriage: z.string(),
  provinceOfMarriage: z.string(),
  countryOfMarriage: z.string(),
  liveTogetherSince: z.string(),
  liveTogetherUntil: z.string(),
  reasonMarriageEnded: z.string(),
  dateMarriageEnded: z.string(),
  citymarriageEnded: z.string(),
  stateMarriageEnded: z.string(),
  provinceMarriageEnded: z.string(),
  countryMarriageEnded: z.string(),
  dateOfSeperation: z.string(),
  howMarriageEnded: z.string(),
  householdMember: z.boolean(),
  headOfHousehold: z.boolean(),
  derivativeApplicant: z.boolean(),
  principalApplicant: z.boolean(),
