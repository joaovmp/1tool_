...
import {
  ...
  PersonalContactFamily_MotherSchema,
  PersonalContactFamily_ChildrenSchema,
  PersonalContactFamily_SpouseSchema,
  IdSchema,
...
export const createPersonalContactFamily_Mother = enhanceAction(
  async function (payload) {
    ...
    try {
      ...
      const { error } = await client.from('contact_family_mother')
        .insert(
          {
            ...payload,
            user: userId
  ...
  {
    schema: PersonalContactFamily_MotherSchema
  },
)


export const editPersonalContactFamily_Mother = enhanceAction(
  async function (payload) {
    const client = getSupabaseServerActionClient();
    try {
      const { error } = await client.from('contact_family_mother')
  ...
  {
    schema: PersonalContactFamily_MotherSchema.merge(IdSchema),
  },
);

export const deletePersonalContacFamily_Mother = enhanceAction(
  async function (payload) {
...
export const createPersonalContactFamily_Children = enhanceAction(
  async function (payload) {
    ...
    try {
      ...
      const { error } = await client.from('contact_family_children')
        .insert(
          {
            ...payload,
            user: userId
  ...
  {
    schema: PersonalContactFamily_ChildrenSchema
  },
)


export const editPersonalContactFamily_Children = enhanceAction(
  async function (payload) {
    const client = getSupabaseServerActionClient();
    try {
      const { error } = await client.from('contact_family_children')
  ...
  {
    schema: PersonalContactFamily_ChildrenSchema.merge(IdSchema),
  },
);

export const deletePersonalContacFamily_Children = enhanceAction(
  async function (payload) {
...
export const createPersonalContactFamily_Spouse = enhanceAction(
  async function (payload) {
    ...
    try {
      ...
      const { error } = await client.from('contact_family_spouse')
        .insert(
          {
            ...payload,
            user: userId
  ...
  {
    schema: PersonalContactFamily_SpouseSchema
  },
)


export const editPersonalContactFamily_Spouse = enhanceAction(
  async function (payload) {
    const client = getSupabaseServerActionClient();
    try {
      const { error } = await client.from('contact_family_spouse')
  ...
  {
    schema: PersonalContactFamily_SpouseSchema.merge(IdSchema),
  },
);

export const deletePersonalContacFamily_Spouse = enhanceAction(
  async function (payload) {
