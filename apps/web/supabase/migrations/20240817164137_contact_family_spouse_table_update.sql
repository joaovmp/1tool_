alter table "public"."contact_family_spouse" alter column "derivativeApplicant" drop not null;

alter table "public"."contact_family_spouse" alter column "headOfHousehold" drop not null;

alter table "public"."contact_family_spouse" alter column "householdMember" drop not null;

alter table "public"."contact_family_spouse" alter column "principalApplicant" drop not null;
